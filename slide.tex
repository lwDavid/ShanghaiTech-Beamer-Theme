...
\author{姓名}
\title{ShanghaiTech Beamer Theme}
\subtitle{毕业设计开题报告}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            ...
            {pic/ShanghaiTech_University_Logo.eps}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{为什么使用Beamer}
    \begin{itemize}[<+-| alert@+>] % 除使用alert，也可手动插入 \pause
        ...
        \item 中文支持请选择 Xe\LaTeX{} 编译选项
         \item Overleaf项目地址位于 \url{https://www.overleaf.com/latex/templates/shanghaitech-beamer-theme/tdqzswchqmjq}
    \end{itemize}
\end{frame}
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.2\linewidth]{pic/ShanghaiTech_University_Logo.eps}
        \caption{这个校徽就是矢量图}
    \end{figure}
\end{frame}
